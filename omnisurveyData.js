var Omnisurvey_Data = new function() {
  ...
  // The data tables below are copy/pasted from data outputted by Access (RivDB_BuildSurvey)
	var tbljsLeagues = { 
		...
		lgID_006: {lgID:10, lgSport:"Basketball", lgName:"NBA", lgCurrentSurvID:18, lgSlug:"s_m_bkb_nba", lgFullName:"National Basketball Association", lgTheFullName:"the National Basketball Association", lgHasProRel:false, lgBritishSpelling:false, lgNumOfFavteamSublevels:0}, 
